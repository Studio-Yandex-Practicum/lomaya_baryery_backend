...
async def send_rejection_registration(user: models.User):
    await bot.send_message(
        chat_id=user.telegram_id,
        text=(
            "Вы уже зарегистрированы на проекте. Повторная регистрация "
            "запрещена. Если вы хотите участвовать заново в проекте, нажмите "
