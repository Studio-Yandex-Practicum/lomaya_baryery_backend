...
SHIFT_STATUS_ENUM_POSTGRES = postgresql.ENUM(
    "started", "finished", "ready_for_complete", "preparing", "cancelled", name="shift_status"
)
...
REPORT_STATUS_ENUM_POSTGRES = postgresql.ENUM(
    "reviewing", "approved", "declined", "waiting", "skipped", "not_participate", name="report_status"
)
