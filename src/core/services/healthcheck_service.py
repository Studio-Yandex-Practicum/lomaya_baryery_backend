...
from src.api.response_models.healthcheck import ComponentItemHealthcheck, HealthcheckResponse
...
class HealthcheckService:
    ...
    async def get_healthcheck_status(self, bot: Application.bot) -> HealthcheckResponse:
        components = [
            await self.__get_bot_status(bot),
            await self.__get_api_status(),
            await self.__get_db_status()]
