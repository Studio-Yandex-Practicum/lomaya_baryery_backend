...
class UserTaskService:
    ...
    # TODO переписать
    async def get_tasks_report(self, shift_id: UUID, task_date: date, pagination) -> list[dict[str, Any]]:
        ...
        for user_task_id, user_id, task_id in user_task_ids:
            task = await self.__task_repository.get_tasks_report(user_id, task_id, pagination)
